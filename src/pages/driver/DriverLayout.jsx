...
export default function DriverLayout() {
  const items = [
    ...
    { to: "/driver/vehicles", label: "My Vehicles", icon: "🚗" },
    { to: "/driver/penalties", label: "Penalties & Fines", icon: "⚠️" },
    { to: "/driver/payments", label: "Payments & Receipts", icon: "💳" },
    { to: "/driver/incidents", label: "Report Incident", icon: "🚨" },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 text-slate-100 flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        ...
        <footer className="text-center py-4 text-xs text-slate-500 border-t border-slate-800/50 bg-slate-950/40">
          SLREPSMS • Driver Portal • Authorized Access Only • ©{" "}
